...
public class FastCollinearPointsTest {
	...
	public void Four_Collinear_Point_Test() {
		...
		assertEquals(p1.toString() + " -> " + p4.toString(), fcp.segments()[0].toString());
	}
	...
	public void Five_Collinear_Point_Test() {
		...
		FastCollinearPoints fcp = new FastCollinearPoints(points);
		assertEquals(1, fcp.numberOfSegments());
		assertEquals(p0.toString() + " -> " + p4.toString(), fcp.segments()[0].toString());
	}
	...
	public void Two_Collinear_LineSegmentsTest() {
		...
		assertEquals(p1.toString() + " -> " + p7.toString(), fcp.segments()[0].toString());
		assertEquals(p1.toString() + " -> " + p4.toString(), fcp.segments()[1].toString());
	}
